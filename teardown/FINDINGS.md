...
- **`RANK` в тройке `SEASON / SCORE / RANK`.** Настоящей таблицы лиги у нас
  нет до шага 3, поэтому пока выводится **ожидаемое место в заезде** — тоже из
  `placeDist`. Заменить на позицию в standings, когда они появятся.
