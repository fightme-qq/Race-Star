...
const ECONOMY_SLOTS = [
  { key: 'e0', name: 'Ticket Marketing',     tag: 'income', base: 33, pg: 2.290, gain: 0.492, unit: '$/с',   effect: 'incomePerSec' },
  { key: 'e1', name: 'Parking',              tag: 'income', base: 50, pg: 2.285, gain: 0.667, unit: '$/с',   effect: 'incomePerSec' },
  { key: 'e2', name: 'Grandstands',          tag: 'fans',   base: 50, pg: 1.320, gain: 0.576, unit: 'фан.',  effect: 'fansPerRace' },
  { key: 'e3', name: 'Victory Celebrations', tag: 'income', base: 50, pg: 2.305, gain: 0.316, unit: 'с',     effect: 'winBonusSec' },
]
