...
// 8: шаги 6-7 — гир драйверов (`gear`), гараж с машинами и частями (`garage`),
//    счётчик пробега класса `cls.races`, от которого открываются слоты гира.
//    Старый сейв не переносится: слоты считались бы от undefined, а сила
//    команды выросла на две оси, под которые прежние цены не подбирались.
const VERSION = 8
