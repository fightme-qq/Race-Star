...
// 9: обучение (`tutorial`) — шаг сценария, отметки `seen` и снятие ворот
//    вкладок. Старый сейв не переносится: без блока `current` читал бы шаг из
//    undefined, а ворота открылись бы игроку, который их не проходил, — то
//    есть ровно тот экран из шести вкладок сразу, ради которого блок и заведён.
const VERSION = 9
