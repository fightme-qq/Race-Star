...
export const SCREENS = {
  ...
  // БЕЗ выдачи денег: шаг снимается ровно в том состоянии, в котором его видит
  // живой игрок. Раньше здесь стояло cash 1e6, и кадр показывал активную
  // кнопку «Upgrade» там, где у игрока была серая — то есть стенд скрывал
  // ровно тот дефект, ради которого его и снимают.
  tutorialBuy: { open: null, tutorial: 4 },
